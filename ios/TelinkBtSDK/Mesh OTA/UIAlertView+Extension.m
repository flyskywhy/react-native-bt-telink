...
//  JinAnSecurity
//
//  Created by AllenKwok on 15/10/13.
...
+(void)alertWithMessage:(NSString *)message{
    UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"Hint" message:message delegate:nil cancelButtonTitle:@"Sure" otherButtonTitles:nil, nil];
    [alert show];
}
